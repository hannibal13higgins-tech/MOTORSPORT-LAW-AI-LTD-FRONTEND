      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="bg-[#111827] border border-[#1f2937] rounded-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border border-[#e0e0e0] text-[#3c4043] text-sm font-medium py-3 px-4 rounded-lg hover:bg-[#f8f9fa] disabled:opacity-50 disabled:cursor-not-allowed"
          >
